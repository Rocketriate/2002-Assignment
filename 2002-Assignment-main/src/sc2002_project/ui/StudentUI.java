...
public class StudentUI {
    ...
    public void runMenu(Student user, LoginUI loginUI) {
        ...
        currentFilter = new FilterOptions(activeId);
        ...
        while (operation) {
            ...
            switch (choice) {
                case "1":
                    this.internshipController.filterView(activeId, currentFilter);
                    break;
                case "2":
                    this.currentFilter.updateFilters();
                    break;
                case "3":
                    this.applicationController.appView(activeId);
                    break;
                case "4":
                    this.applicationController.accept(activeId);
                    break;
                case "5":
                    this.applicationController.createApp(activeId);
                    break;
                case "6":
                    this.applicationController.requestWithdraw(activeId);
                    break;
                case "7":
